...
<p ><input style="color:red;font-size:25px;font-weight: bold; margin-left:60%;" type="submit" name="search1" value="SEARCH"/></p>
</form>	
</div>
...
echo"<td>"."<input type=text name=accountt value=".$row['account']." </td>"; 
echo"</tr>";	
echo"<tr>";
